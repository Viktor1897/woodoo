...
document.querySelectorAll('.booksy-widget-button')[2].textContent = 'Zarezerwuj online';
...
const translationPL = ['Usługi', 'Galeria', 'Akademia', 'Kontakt', 'Najlepszy fryzjer męski w Poznaniu',
  ...
  'Strzyżenie (PREMIUM BARBER)', 'Strzyżenie (TOP BARBER)', 'Strzyżenie', 'Strzyżenie Brody', 'Strzyżenie chłopca (4-11 lat)', 'Strzyżenie maszynką (1 nakładka)',
  'Strzyżenie + broda (PREMIUM BARBER)', 'Strzyżenie + broda (TOP BARBER)', 'Strzyżenie + broda', 'Strzyżenie tata + syn', 'Odsiwianie włosów', 'Odsiwianie brody', 'Woskowanie (jedna strefa)',
  'Oczyszczanie twarzy (czarna maska)', 'Płatki pod oczy', 'Galeria', 'Więcej zdjęć na instagramie',
  'Zostań profesjonalnym Barberem. Dzięki naszej akademii', 'Więcej info na stronie SIMPLE Academy', 'PLACÓWKI',
  'Poznań, ul. Bukowska 78', 'Poznań, ul. Świerzawska 4', 'Poznań, ul. Katowicka 55B', 'Pn - Ndz: 9:00 - 21:00', 'Usługi', 'Galeria', 'Akademia', 'Kontakt', 'Rezerwacja'];
...
const translationEN = ['Services', 'Gallery', 'Academy', 'Contact',
  ...
  'Services', 'Haircut (PREMIUM BARBER)', 'Haircut (TOP BARBER)', 'Haircut', 'Beard trim', 'Boy\'s haircut (4-11 years)', 'Clipper haircut (1 guard)',
  'Haircut + Beard (PREMIUM BARBER)', 'Haircut + Beard (TOP BARBER)', 'Haircut + Beard', 'Haircut Father + Son', 'Gray hair camo', 'Gray beard camo', 'Waxing (one zone)',
  'Face cleansing (black mask)', 'Eye patches', 'Gallery', 'More photos on Instagram',
  'Become a professional Barber. Thanks to our academy', 'More information on the SIMPLE Academy website',
  'LOCATIONS', 'Poznan, Bukowska 78 st.', 'Poznan, Swierzawska 4 st.', 'Poznan, Katowicka 55B st.', 'Mon - Sun: 9:00 - 21:00', 'Services', 'Gallery', 'Academy', 'Contact', 'Book online'];
...
function changeLanguage() {
  if (lang === 'pl') {
    ...
    document.querySelectorAll('.booksy-widget-button')[2].textContent = 'Book online';
    lang = 'en';
  } else {
